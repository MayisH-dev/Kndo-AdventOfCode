...
// Remember sum as 0
// For each line
    // Start from left side of the line and go by one character to the right
        // if the current character is a digit
        // remember it
        // Stop
    // Start from the right side of the line and go by one character to the left
        // if the current character is a digit
        // remember it
        // Stop
    // Concatenate them to each other
...
char firstDigitFromLeftSide = ' ';
// Console.WriteLine(firstDigitFromLeftSide);
// Split text by line
string[] documentLines = document.Split(Environment.NewLine);
int sum = 0;
// For each line start
for (int j = 0; j < documentLines.Length; j++)
{
    string line = documentLines[j];
    // 1. For loop
    for (int i = 0; i < line.Length; i++)
    {
        ...
        {
            // 3. Assignment
            firstDigitFromLeftSide = currentChar;
            // 4. Break statement
            break;
        }
    }
    char firstDigitFromRightSide = ' ';
    // 5. For loop
    for (int i = line.Length - 1; i >= 0; i--)
    {
        ...
        {
            // 3. Assignment
            firstDigitFromRightSide = currentChar;
            // 4. Break statement
            break;
        }
    }
    string number = String.Concat(firstDigitFromLeftSide, firstDigitFromRightSide);
